...
jQuery(document).ready(function ($) {
  ...
  var videoPlayAbout = function videoPlayAbout() {
    ...
    var btnClose = $('.about-list .float-video__close');
    btn.click(function (e) {
      e.preventDefault();
      var video = $(this).parent().parent().parent().find('.float-video video')[0];
      videoPP(video, $(this));
    });
...
},{"imask":1,"jquery":5,"jquery-match-height-browserify":2,"jquery-popup-overlay":3,"svg4everybody":6}]},{},[7]);
