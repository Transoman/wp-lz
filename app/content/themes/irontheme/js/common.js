...
},{"./jquery.popupoverlay":4}],4:[function(require,module,exports){
/*!
...
jQuery(document).ready(function ($) {
  ...
  var videoPP = function videoPP(video, btn) {
    if (video) {
      var target = $(video).parent();
      setTimeout(function () {
        $('body, html').animate({
  ...
  var videoPlayAbout = function videoPlayAbout() {
    var btn = $('.about-list .btn-play');
    btn.click(function (e) {
      e.preventDefault();
      var video = $(this).parent().find('.float-video video')[0];
      videoPP(video, $(this));
    });
  };

  var closeVideo = function closeVideo() {
    var btnClose = $('.float-video__close');
  ...
  var videoPlayWhy = function videoPlayWhy() {
    var btn = $('.why-list .btn-play');
    var btnClose = $('.why-list .float-video__close');
    btn.click(function (e) {
      e.preventDefault();
  ...
  var videoPlayFaq = function videoPlayFaq() {
    var btn = $('.faq-list .btn-play');
    btn.click(function (e) {
      e.preventDefault();
      var video = $(this).parent().find('.float-video video')[0];
      videoPP(video, $(this));
  ...
  var showDescr = function showDescr() {
    var btn = $('.btn-text');
    var btnClose = $('.float-descr__close');
    btn.click(function (e) {
      e.preventDefault();
      ...
      var target = $(this).next('.float-descr');
      setTimeout(function () {
        $('body, html').animate({
          scrollTop: target.offset().top - 20
        }, 1000);
  ...
  var showDescrWhy = function showDescrWhy() {
    var btn = $('.btn-text');
    var btnClose = $('.float-descr__close');
    btn.click(function () {
...
},{"imask":1,"jquery":5,"jquery-match-height-browserify":2,"jquery-popup-overlay":3,"simplebar":6,"svg4everybody":7}]},{},[8]);
